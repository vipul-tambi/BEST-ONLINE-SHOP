...
import UserOrderDetailsPageComponent from "./components/UserOrderDetailsPageComponents";
...
const loadPayPalScript = (
  ...
  loadScript({
    "client-id":
      "AfW_TvqKomEFB2hDGfkoxo4fLHtMVadNdUqYS9HV-M2eTgrgpIfk9IJP1kPcCVoroFlcIA15oklrMR6f",
  })
    .then((paypal) => {
      paypal
        .Buttons(
